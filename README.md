## hector_gazebo (noetic) - 0.5.3-1

The packages in the `hector_gazebo` repository were released into the `noetic` distro by running `/usr/local/bin/bloom-release hector_gazebo --rosdistro noetic` on `Wed, 03 Feb 2021 15:42:09 -0000`
